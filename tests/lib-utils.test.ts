...
describe('lib/utils formatElapsedTime', () => {
  ...
  it('returns zero seconds for negative durations', () => {
...
describe('lib/utils formatClickScoreCompact', () => {
  ...
  it('compacts the exact thousand score boundary', () => {
    expect(formatClickScoreCompact(1_000n)).toBe('1.0K')
  })
...
describe('lib/utils clicksPerSecond', () => {
  ...
  it('returns zero for negative elapsed windows', () => {
    expect(clicksPerSecond(120n, -1)).toBe(0)
  })
})
...
describe('lib/utils formatClicks', () => {
  ...
  it('formats the exact million click boundary', () => {
    expect(formatClicks(1_000_000)).toBe('1.0M')
  })
